...
class OwnerDevisListView extends StatefulWidget {
  const OwnerDevisListView({super.key});

  @override
  State<OwnerDevisListView> createState() => _OwnerDevisListViewState();
}

class _OwnerDevisListViewState extends State<OwnerDevisListView> {
  ...
  void _loadAllDevis() async {
    await controller.loadDevisBasedOnRole();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: SunwinnersAppBar(
        ...
        leading: const Icon(Icons.arrow_back, color: Color(0xFFffd60a)),
          ...
          child: Container(
            ...
            child: Material(
              ...
              child: InkWell(
                borderRadius: BorderRadius.circular(12),
                onTap: () {
                  Get.toNamed(AppRoutes.ownerDevisDetail, arguments: devis.id);
                },
                child: Padding(
