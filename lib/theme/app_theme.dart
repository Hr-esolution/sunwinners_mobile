...
class AppTheme {
  ...
  static TextTheme _buildTextTheme({bool isDark = false}) {
    ...
    return TextTheme(
      ...
      bodyMedium: AppTypography.caption.copyWith(color: isDark ? AppColors.lightGray : AppColors.mediumGray),
      bodySmall: AppTypography.caption.copyWith(color: isDark ? AppColors.lightGray : AppColors.mediumGray),
    );
  }
  ...
  static ChipThemeData _buildChipTheme({bool isDark = false}) {
    ...
    return ChipThemeData(
      ...
      secondaryLabelStyle: AppTypography.caption.copyWith(color: selectedTextColor),
  ...
  static SnackBarThemeData _buildSnackBarTheme({bool isDark = false}) {
    final bgColor = isDark ? AppColors.darkGray.withOpacity(0.95) : AppColors.darkGray.withOpacity(0.95);
