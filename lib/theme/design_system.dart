...
class DesignSystem {
  ...
  static const Duration loaderDuration = Duration(
    seconds: 1,
    milliseconds: 200,
  );

  /// Component Dimensions
  static const Size buttonSize = Size(
    double.infinity,
    44,
  ); // Button height: 44px
  static const Size iconButtonSize = Size.square(40); // Icon button: 40x40px
  static const Size inputFieldSize = Size(
    double.infinity,
    40,
  ); // Input height: 40px
  ...
  ThemeData createLightTheme() {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        primary: gold,
        secondary: green,
        surface: lightGreen, // remplacer background par surface
        background: lightGreen, // tu peux le laisser si tu veux compatibilité
        error: red,
        onPrimary: white,
        onSecondary: white,
        onSurface: darkGray, // remplacer onBackground
  ...
  ThemeData createDarkTheme() {
    return ThemeData(
      ...
      colorScheme: ColorScheme.dark(
        primary: gold,
        secondary: green,
        surface: navyBlue, // remplacer background par surface
        background: navyBlue,
        error: red,
        onPrimary: white,
        onSecondary: white,
        onSurface: white, // remplacer onBackground
        onBackground: white,
        onError: white,
      ),
      useMaterial3: true,
